...
export default function About() {
  return (
    <div className="min-h-screen bg-gray-50 text-gray-800">
      ...
      {/* 🔹 Твоя текстова секція залишається без змін */}
      <section className="py-16 px-6 max-w-4xl mx-auto text-lg leading-relaxed text-gray-700">
        ...
        <p className="mb-6">
          Наші притиски сумісні з популярними моделями верстатів <strong>SCM, Biesse, Altendorf, KDT, Holzmann</strong> 
          та іншими аналогами, що використовуються на виробництвах по всій Україні.
        </p>
        <p className="mb-6">
